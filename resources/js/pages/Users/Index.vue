...
watch(search, (value) => {
    router.get(
        route('users.index'), // Use Laravel's route helper if available
        { search: value },
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div>
            ...
            <div class="flex justify-between items-center p-1">
                <div>
                    <Link v-if="can('user.create') || can('all')" :href="route('users.create')"
            ...
            <div class="p-3">
                ...
                <div class="overflow-x-auto mt-4">
                    <table class="w-full text-sm text-left text-gray-700">
                        ...
                        <tbody>
                            <tr v-for="user in props.users.data" :key="user.id" class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
            ...
            <nav class="flex justify-center mt-2" aria-label="Page navigation example">
                <ul class="inline-flex -space-x-px text-sm">
                    <li v-for="link in props.users.links" :key="link.label" :disabled="!link.url">
